...
// import generatedsvg from "../assets/generated-svg-image.svg"
    ...
    transform: rotate(2deg);
      ...
      <div className="min-h-screen relative py-6 w-[80%] mx-auto" id="Project">
        <motion.h1
          ...
          className="text-5xl py-11 text-left md:text-center"
          style={{ color: "rgb(252, 16, 86)" }}
        >
          Proj<span className="text-white">ect</span>
        </motion.h1>
        <div className="flex flex-col md:flex-row justify-between">
          <ScrollAnimation animateIn="bounceInLeft" duration={2.7} delay={100}>
            <div className="h-[60vh] flex w-[300px]  md:w-[400px]">
              {/* <img src={generatedsvg} alt="" /> */}
              {/* <g style={swingStyle}>
            <rect x="45" y="20" width="10" height="60" fill="#8B4513" /> 
            <rect x="30" y="80" width="40" height="5" fill="#8B4513" /> 
            <circle cx="50" cy="30" r="5" fill="#FFC0CB" />
            <rect x="48" y="35" width="4" height="20" fill="#FF69B4" /> 
            <line x1="50" y1="35" x2="45" y2="50" stroke="#FF69B4" stroke-width="3" /> 
            <line x1="50" y1="35" x2="55" y2="50" stroke="#FF69B4" stroke-width="3" /> 
            <line x1="50" y1="55" x2="45" y2="70" stroke="#FF69B4" stroke-width="3" /> 
            <line x1="50" y1="55" x2="55" y2="70" stroke="#FF69B4" stroke-width="3" /> 
        </g> */}
              ...
              >
                <g id="undraw_Tree_swing_646s 1" clip-path="url(#clip0)">
                  ...
                  <path
                    id="Vector_26"
                    d="M1006 827.544H58.0041V830H1006V827.544Z"
                    fill="white"
                  ></path>
                  <g id="Girl" style={swingStyle}>
                    <path
                      id="Vector_27"
                    ...
                    <path
                      id="Vector_46"
                      d="M750.77 713.904H635.505V737.232H750.77V713.904Z"
                      fill="#212121"
                    ></path>
                    <path
                      id="Vector_47"
                ...
                <g id="undraw_Tree_swing_646s 1" clip-path="url(#clip0)">
                    ...
                    <g id="Girl">
                        ...
                        <path id="Vector_45"
                            d="M682.619 619.33C682.619 619.33 676.596 627.713 676.596 637.669C676.596 647.624 684.124 680.633 688.14 680.633C692.155 680.633 724.278 662.295 724.278 662.295L719.761 653.387L696.673 663.866C696.673 663.866 699.684 615.138 682.619 619.33Z"
                            fill="#D0CDE1" />
                        <path id="Vector_46" d="M750.77 713.904H635.505V737.232H750.77V713.904Z" fill="#3f3d56" />
                        <path id="Vector_47"
                            d="M693.138 738.459C690.643 738.456 688.252 737.421 686.488 735.579C684.724 733.738 683.731 731.241 683.728 728.637V452.382C683.728 450.525 684.233 448.705 685.183 447.135C686.134 445.565 687.491 444.308 689.098 443.511C690.705 442.713 692.496 442.408 694.262 442.63C696.029 442.852 697.699 443.592 699.078 444.764L697.592 446.669C696.557 445.789 695.305 445.234 693.98 445.068C692.655 444.901 691.312 445.131 690.107 445.729C688.902 446.327 687.884 447.269 687.172 448.447C686.459 449.625 686.081 450.989 686.081 452.382V728.637C686.083 730.59 686.827 732.463 688.15 733.844C689.473 735.225 691.267 736.002 693.138 736.004V738.459Z"
                            fill="#3f3d56" />
                        <path id="Vector_48"
          ...
          <div className="flex flex-col justify-center w-full md:w-1/2">
            <ScrollAnimation
              ...
              delay={300}
            >
<p className="text-sm leading-5 tracking-widest md:text-lg text-gray-400 md:leading-8 mb-4">
  ⚡ I work with many modern tech tools, mainly in frontend development. I have a strong background in HTML, CSS, and JavaScript, and I’ve built many applications using React.js. Below, you can see some of my projects. Keep in mind that not all of them are on GitHub yet.
</p>
        ...
        <div className="text-white grid grid-cols-1 md:grid-cols-2 gap-10">
          {projectdata.map((item, index) => (
            <ScrollAnimation
              animateIn="flipInX"
              className="flex flex-col p-7 rounded-lg border-[1px] border-[#ffffff4d] "
              key={index}
            ...
            >
              <span className="flex-grow">
                <h1 className="text-lg md:text-4xl font-semibold">{item.name}</h1>
              </span>
              <div className="py-4">
                <Link to={item.link}>
                  <img
                    src={item.img}
                    alt=""
                    className="object-cover md:h-[35vh] w-full rounded-md transform transition-transform duration-300 hover:scale-105"
                  />
                </Link>
                <p className="text-gray-400 text-sm leading-7 tracking-widest p-2">
                  {item.content}
                </p>
              </div>
              ...
              <div className="flex h-[14vh] items-end justify-between">
                ...
                <div className="flex justify-end gap-2 pt-3">
                  <a
                    href={item.link}
                    className="text-white  font-semibold border border-[#ffffff4d] flex items-center gap-3 p-2 uppercase rounded-md tracking-wide"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                   <span className="hidden md:flex">go live</span><FaExternalLinkAlt/>
                  </a>
                  <a
                    href={item.git}
                    className="text-white font-semibold border border-[#ffffff4d]  flex items-center gap-3 p-2 uppercase rounded-md tracking-wide"
                    ...
                    rel="noopener noreferrer"
                  >
                    <span className="hidden md:flex">GitHub</span> <FaGithub/>
                  </a>
                </div>
              </div>
            </ScrollAnimation>
        ...
        <div className="w-full text-center py-5">
          <a href="https://github.com/pokiabhishek">
            <button
              className="text-white p-3 md:text-md rounded-md font-semibold hover:scale-110 transition-transform duration-200 tracking-tighter"
              style={{
                background: "rgb(252, 16, 86)",
              }}
            >
              View all projects
            </button>
