    ...
    <div className="Timeline w-[80%] mx-auto" id="Education">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div data-aos="fade-down" className="text-center md:text-left">
          ...
          <p className="text-white text-xl md:text-2xl mt-3 px-2">
            Basic Qualification
          </p>
        </div>
        <ScrollAnimation
        ...
        {/* <img src={education} alt="Education" className="w-full md:w-1/2 rounded mt-4 md:mt-0" data-aos="zoom-in-up" /> */}
      </div>
      ...
      <VerticalTimeline lineColor="#212121">
        ...
        <VerticalTimelineElement       
          className="vertical-timeline-element--education ml-auto"
          iconStyle={{ background: "#000", color: "#fff" }}
          icon={<FaGraduationCap />}
